  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <div className="bg-gradient-to-tr from-[#fff] via-[#e0f1ff] to-[#6cbdff] md:px-20 2xl:px-40 text-[#556B78] pt-[100px]  px-10 pb-20 min-h-[100vh] text-center ">
          <h2 className="font-bold text-5xl">Quiz Time!</h2>

          <div className="timer-container text-lg bg-white rounded-lg mt-5">
            ...
            <div className="">
              <p
                ...
                className="bg-blue-400 text-white rounded-lg p-2 m-2 hover:bg-blue-700 cursor-pointer"
              >
